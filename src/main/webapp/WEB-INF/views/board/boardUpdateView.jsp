...
<h1 align="center">${board.boardNum } 번 게시글원글 수정 페이지</h1>
<br>
...
<table align="center" width="700" border="1" cellspacing="0" cellpadding="5">
	...
	<tr><th colspan="2">
		...
		<input type="button" value="목록" onclick="location.href='blist.do?page=${correntPage}; return false;"> &nbsp;		
	</th></tr>
</table>
</form>
</c:if>
...
<%-- 댓글,대댓글 수정 폼 : 첨부파일 수정 기능 djqtdma --%>
